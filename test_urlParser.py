...
class basicProtocolParsing(unittest.TestCase):
	...
	def other_protocol(self):
                self.assertProtocol('w61w://some.site.com', 'w61w')
...
class basicPathParsing(unittest.TestCase):
	...
	def test_empty_path_wtih_sub_folders(self):
		self.assertPath('http://www.essex.com/homework/joy.txt', 'homework/joy.txt')
